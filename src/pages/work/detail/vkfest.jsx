          ...
          <Container>
            ...
            <div className="grid grid-cols-1 gap-[3rem] md:gap-[8rem]">
              ...
              <div className="grid gap-y-6 grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-3 space-y-6">
                  <h5 className="text__32">
                    Проанализировала, что самое важное должен увидеть пользователь на фестивале: в полевых условиях нельзя заставлять человека долго что-то искать. Сделала крупные, заметные плашки в меню и ярко подсветила артистов, которые сейчас выступают, — чтобы нужное считывалось с одного взгляда, а не терялось в списке.
                  </h5>
                </div>
              </div>

          ...
          <Container>
            ...
            <WrapAnimateUp step={step}>
              <p className="text-[13px] sm:text-[16px] lg:text-[18px] italic opacity-60 text-center w-full mb-[3rem] md:mb-[6rem]">
                Крупная алкогольная розничная сеть, NDA. Два мобильных приложения — B2C для покупателей и B2B для дистрибьютора — с разной логикой под разные задачи.
              </p>
            </WrapAnimateUp>
            ...
            <div className="grid grid-cols-1 gap-[3rem] md:gap-[8rem]">
              ...
              <div className="grid gap-y-6 grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-3 space-y-6">
                  <h5 className="text__32">
                    Склады по всей стране, тысячи клиентов, десятки тысяч точек продаж. Два продукта — две разные аудитории с противоположными задачами: в B2C покупатель исследует, сравнивает, выбирает под настроение, а в B2B точка продаж заходит со списком на закупку и дедлайном, при этом менеджеры дистрибьютора одновременно ведут десятки, а то и сотню с лишним клиентов. Оба продукта делались с нуля, параллельно, вместе с аналитиком — я отвечала за проектирование и сопровождение разработки.
                  </h5>
                </div>
              </div>
              ...
              <div className="grid gap-y-6 grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-3 space-y-6">
                  <h5 className="text__32">
                    Начала с CJM и user flow — разложила оба сценария по шагам, чтобы понять, какие фичи нужны в первую очередь, а что можно отложить. Собрала референсы, накидала концепцию и только потом перешла к прототипам, а затем к макетам, шаг за шагом. Один интерфейс на оба продукта не работал бы, поэтому B2C и B2B с самого начала проектировала параллельно, но раздельно.
                  </h5>
                </div>
              </div>
              ...
              <div className="grid gap-y-6 grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-3 space-y-6">
                  <h5 className="text__32">
                    Оба приложения запущены и работают. Клиент остался доволен результатом — я продолжаю сотрудничество с ним.
                  </h5>
                </div>
              </div>

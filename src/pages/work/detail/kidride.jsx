          ...
          <Container>
            ...
            <WrapAnimateUp step={step}>
              <p className="text-[13px] sm:text-[16px] lg:text-[18px] italic opacity-60 text-center w-full mb-[3rem] md:mb-[6rem]">
                KidRide — сервис сопровождения детей профессиональными водителями от двери до двери. Мобильное приложение для водителей 45+.
              </p>
            </WrapAnimateUp>
            ...
            <div className="grid grid-cols-1 gap-[3rem] md:gap-[8rem]">
              ...
              <div className="grid gap-y-6 grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-3 space-y-6">
                  <h5 className="text__32">
                    Нужно было спроектировать интерфейс, который остаётся понятным, безопасным и не отвлекает от дороги. Прозрачность маршрута и статусов должна была повысить доверие родителей к сервису.
                  </h5>
                  <h5 className="text__32">
                    Аудитория нестандартная: большинству водителей за 45, часть имеет проблемы со зрением. Многие раньше работали в агрегаторах, и главная их жалоба была одна — приложение постоянно требует что-то нажать: на маршруте, на светофоре, в пробке.
                  </h5>
                </div>
              </div>
              ...
              <div className="grid gap-y-6 grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-3 space-y-6">
                  <h5 className="text__32">
                    Чтобы не проектировать под воображаемого пользователя, провела глубинные интервью — отдельно с руководителями сервиса, отдельно с водителями. Выяснилось, что задачи бизнеса и реальные боли водителей в нескольких местах расходились; эти данные легли в основу функционала вместе с аналитиком. Из интервью вышли три проблемы, которые решались параллельно, и каждая повлияла на дизайн-решения.
                  </h5>
                </div>
              </div>
              ...
              <div className="grid gap-y-6 grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-3 space-y-6">
                  ...
                  <h5 className="text__32">
                    Ночные поездки я закрыла тёмной темой как единственным вариантом на старте. Светлая тема запланирована в следующих версиях, но для MVP это было лишним — сначала безопасность.
                  </h5>
                  <h5 className="text__32">
                    Флоу поездки я сократила до трёх обязательных действий: водитель принял заказ, подтвердил посадку, закрыл поездку. Всё остальное — опционально или автоматически. Это принципиальное отличие от агрегаторов, где приложение живёт своей жизнью рядом с водителем.
                  </h5>
                </div>
              </div>

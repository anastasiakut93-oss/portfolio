...
const ScrollTextReveal = () => {
  ...
  useEffect(() => {
    if (elementPosition.height > 0) {
      ...
      const startPosition = elementPosition.top - window.innerHeight * 0.6 // start when element is 60% into viewport
      const endPosition = elementPosition.top + elementPosition.height * 0.4
      ...
      <div ref={containerRef} className="relative w-full overflow-hidden h-[800px] lg:h-auto will-change-transform">
          ...
          <h5 className="leading-snug">
            <span className="overflow-hidden inline-block">
              <span className="inline-block w-max">
                Привет, я Анастасия — product designer
              </span>
            </span>
            <br />
            <span className="overflow-hidden inline-block">
            ...
            <br />
            <span className="overflow-hidden inline-block">
              <span className="inline-block w-max">Рутина занимает теперь минуты, не часы.</span>
            </span>{" "}
          </h5>
        ...
        >
          <h5 className="leading-snug relative">
            {/* Line 1 */}
            <motion.span
              style={{ maxWidth: line1MaxWidth, opacity: line1Opacity, y: line1Y, willChange: "max-width, opacity, transform" }}
            ...
            {/* Line 2 */}
            <motion.span
              style={{ maxWidth: line2MaxWidth, opacity: line2Opacity, y: line2Y, willChange: "max-width, opacity, transform" }}
              className="overflow-hidden max-w-[100%] inline-block transition-all duration-300"
            >
              <span className="inline-block w-max">
                из Петербурга. E-com, martech, HRtech, SaaS — и ещё пара.
            ...
            {/* Line 3 */}
            <motion.span
              style={{ maxWidth: line3MaxWidth, opacity: line3Opacity, y: line3Y, willChange: "max-width, opacity, transform" }}
              className="overflow-hidden max-w-[100%] inline-block transition-all duration-300"
            >
              <span className="inline-block w-max">
                Claude Code и Recraft — работаю с ними каждый день.
            ...
            {/* Line 4 */}
            <motion.span
              style={{ maxWidth: line4MaxWidth, opacity: line4Opacity, y: line4Y, willChange: "max-width, opacity, transform" }}
              className="overflow-hidden max-w-[100%] inline-block transition-all duration-300"
            >
              <span className="inline-block w-max">Рутина занимает теперь минуты, не часы.</span>
            </motion.span>{" "}
          ...
          <h5 className="leading-snug mt-6 relative">
            {/* Line 5 */}
            <motion.span
              style={{ maxWidth: line5MaxWidth, opacity: line5Opacity, y: line5Y, willChange: "max-width, opacity, transform" }}
              className="overflow-hidden max-w-[100%] inline-block transition-all duration-300"
            >
              <span className="inline-block w-max">
                Сейчас ищу B2C-продукт с живыми пользователями
            ...
            {/* Line 6 */}
            <motion.span
              style={{ maxWidth: line6MaxWidth, opacity: line6Opacity, y: line6Y, willChange: "max-width, opacity, transform" }}
              className="overflow-hidden max-w-[100%] inline-block transition-all duration-300"
            >
              <span className="inline-block w-max">
                и задачами, которые не надоедают через месяц.
